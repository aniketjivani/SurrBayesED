...
class GOOEDLG(object):
    """
    A Bayesian optimal experimental design class for goal-oriented design. This class aims to provide numerical and analytical calculations of utility as well as batch design for linear Gaussian case. Optimization for U_KL is performed using Bayesian Optimization via BoTorch. Variational lower bounds are tightened for prior and posterior predictive PDF of z (QoI).
    """
    ...
    def utility_variational():
        """
        Approximation of utility using variational lower bound.
        """
        pass
